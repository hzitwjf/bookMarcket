...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <div class="navbar-header page-scroll">
      ...
      <a class="navbar-brand page-scroll" href="#page-top">合众艾特</a>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To UNION!</div>
          <div class="intro-heading">It's Nice To Meet You</div>
        </div>
        <a class="btn btn-1 btn-sm" href="login.html">To Login</a>
        <a class="btn btn-1 btn-sm" href="findByPage">Go Shoping</a>
      </div>
    </div>
  </div>
</header>
